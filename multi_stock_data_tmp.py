...
#%%
#data_1 = data[data.xref == stock_ids[0]]
#data_2 = data[data.xref == stock_ids[1]]
#data_3 = data[data.xref == stock_ids[-6]]
#data_ = pd.concat([data_1,data_2,data_3],axis = 0)
#data_conc = pd.concat([data_1,data_2],axis = 1)
